        ...
        <div id="content" class="col-sm-9">
            <div class="category-page-wrapper">
                ...
                <div class="grid-list-wrapper">
                    ...
                    <c:forEach items="${requestScope.PaginationModel}" var="product">
                    ...
                    <div class="pagination-inner">
                        <ul class="pagination">
                            <c:if test="${requestScope.PaginationModel.pageNum > 1}">
                                <li><a href="/home/product/searchProduct?key=${param.key}&pageNum=${param.pageNum-1}&pageSiz=20">上一页</a></li>
                            </c:if>
                            <c:if test="${requestScope.PaginationModel.pageNum < requestScope.PaginationModel.totalPages}">
                                <li><a href="/home/product/searchProduct?key=${param.key}&pageNum=${param.pageNum+1}&pageSiz=20">下一页</a></li>
                            </c:if>
                        </ul>
                    </div>--%>
                </div>
