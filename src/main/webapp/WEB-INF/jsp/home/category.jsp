                    ...
                    <div class="product-layout product-list col-xs-12">
                        <div class="product-thumb">
                            <div class="image product-imageblock">
                                <a href="/home/product/queryProduct?id=${product.id}">
                                    <img src="${pageContext.request.contextPath}/uploaded/${product.photo}" title="${product.productName}" class="img-responsive" />
                                </a>
                            </div>
                    ...
                    <div class="pagination-inner">
                        <ul class="pagination">
                            <c:if test="${requestScope.PaginationModel.pageNum > 1}">
                                <li><a href="/home/product/queryProductList?type=${param.type}&pageNum=${param.pageNum-1}&pageSiz=20">上一页</a></li>
                            </c:if>
                            <c:if test="${requestScope.PaginationModel.pageNum < requestScope.PaginationModel.totalPages}">
                                <li><a href="/home/product/queryProductList?type=${param.type}&pageNum=${param.pageNum+1}&pageSiz=20">下一页</a></li>
                            </c:if>
                        </ul>
                    </div>
                </div>
