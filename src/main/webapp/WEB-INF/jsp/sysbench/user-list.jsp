...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content">
            <!-- 右侧内容框架，更改从这里开始 -->
            <form class="layui-form xbs" action="/sysbench/user/queryUserList" method="get">
                <div class="layui-form-pane" style="text-align: center;">
                    <div class="layui-form-item" style="display: inline-block;">
                        <label class="layui-form-label xbs768">用户名</label>
            ...
            <xblock><!--<button class="layui-btn layui-btn-danger" onclick="delAll()"><i class="layui-icon">&#xe640;</i>批量删除</button>-->
                <a href="/sysbench/user/export"><button class="layui-btn" id="export-data"><i class="layui-icon">&#xe64c;</i>数据导出</button></a>
            ...
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td>
                         <fmt:formatDate value="${model.gmtCreate}" pattern="yyyy/MM/dd  HH:mm:ss" />
                    </td>
                </tr>
                </c:forEach>
                </tbody>
        ...
        <xblock>
            <c:choose>
                <c:when test="${requestScope.PaginationModel.pageNum > 1}">
                    <a href="/sysbench/user/queryUserList?username=${param.username}&pageNum=${param.pageNum-1}&pageSiz=10"><button class="layui-btn">上一页</button></a>
                </c:when>
                <c:otherwise>
                    <a href="/sysbench/user/queryUserList?username=${param.username}&pageNum=${param.pageNum-1}&pageSiz=10"><button class="layui-btn" style="color: grey" disabled="disabled">上一页</button></a>
                </c:otherwise>
            </c:choose>
            <c:choose>
                <c:when test="${requestScope.PaginationModel.pageNum < requestScope.PaginationModel.totalPages}">
                    <a href="/sysbench/user/queryUserList?username=${param.username}&pageNum=${param.pageNum+1}&pageSiz=10"><button class="layui-btn">下一页</button></a>
                </c:when>
                <c:otherwise>
                    <a href="/sysbench/user/queryUserList?username=${param.username}&pageNum=${param.pageNum+1}&pageSiz=10"><button class="layui-btn" style="color: grey" disabled="disabled">下一页</button></a>
                </c:otherwise>
            </c:choose>
            <c:choose>
